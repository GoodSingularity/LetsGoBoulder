...
RSpec.describe Context::Ascends::Repository, type: :model do
  context "create method" do
    ...
    it "it success" do
      ...
      event_store = Context::Ascends::Repository.new.create_ascend(args: args)
  ...
  context "add like method" do
    ...
    it "it success" do
      ...
      event_store = Context::Ascends::Repository.new.add_like(args: args, current_user_id: user.id)
  ...
  context "unlike method" do
    ...
    it "it success" do
      event_store = Context::Ascends::Repository.new.unlike(
        ascend_id: ascend.id,
  ...
  context "archive ascend method" do
    ...
    it "it success" do
      event_store = Context::Ascends::Repository.new.archive_ascend(
        id: ascend.id
      )
