...
RSpec.describe Contexts::Routes::Repository, type: :model do
  context "create method" do
    it "it success" do
      ...
      event_store = Contexts::Routes::Repository.new.create(args: args, file_key: SecureRandom.uuid)
  ...
  context "delete method" do
    ...
    it "it success" do
      ...
      event_store = Contexts::Routes::Repository.new.delete(args: args)
  ...
  context "update method" do
    ...
    it "it success" do
      ...
      event_store = Contexts::Routes::Repository.new.update(args: args)
