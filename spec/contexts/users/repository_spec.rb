...
RSpec.describe Contexts::Users::Repository, type: :model do
  context "create method" do
    it "it success" do
      ...
      event_store = Contexts::Users::Repository.new.create_user(auth_provider: auth_provider, name: Faker::Name.name, phone_number: 667089810, avatar_id: SecureRandom.uuid, gender: 0)
  ...
  context "update method" do
    ...
    it "it success" do
      event_store = Contexts::Users::Repository.new.update(
        id: user.id,
        file: file
      )
